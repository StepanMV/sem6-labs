...
GLuint Texture::loadTexture(const std::string &name, const std::string &path)
{
...
GLuint Texture::loadCubemap(const std::string &name, const std::vector<std::string> &paths)
{
    GLuint textureID;
    glGenTextures(1, &textureID);
